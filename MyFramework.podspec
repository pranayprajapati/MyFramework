...
Pod::Spec.new do |spec|
  ...
  #
  	...
  	spec.version      = "0.0.1"
  	spec.summary      = "Short description of MyFramework."
  ...
  spec.description  = <<-DESC
		This s light chat demo. And Short description of MyFramework.
                   DESC

  	spec.homepage     = "https://github.com/pranayprajapati/MyFramework"
  ...
  # Or just: spec.author    = "pranay.prajapati"
  # spec.authors            = { "pranay.prajapati" => "pranay.prajapati@auxanoglobalservices.com" }
  # spec.social_media_url   = "https://twitter.com/pranay.prajapati"
