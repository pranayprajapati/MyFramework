...
public class Utility {
    ...
    //        let dateFormatter = DateFormatter()
    //        //let todayDate : String = Date().toString(format: "dd-MM-yyyy")
    //        dateFormatter.dateFormat = "dd-MM-yyyy"
    //        let todayDate : String = dateFormatter.string(from: Date())
    //        let exDate : String = Utility.convertDateFormaterSubscriptionDetail(expiredDate)
    //        dateFormatter.dateFormat = "dd/MM/yyyy"
    //        let eDate = dateFormatter.date(from: exDate)
    //        let tDate = dateFormatter.date(from: todayDate)
    //
    //        if tDate?.compare(eDate!) == .orderedAscending {
    //            return 1
    //        } else {
    //            let i: Int = todayDate == exDate ? 1 : 0
    //            return i
    //        }
    //    }
